...
for iter = 1:N_SNR
    ...
    [rece_conv2, ~] = conv_decode(conv_encode(send_bits, 2, 0, sigma_n(iter))', N_len, g2, 0, send_bits, 0, 0, 0);
    [rece_conv3, ~] = conv_decode(conv_encode(send_bits, 3, 0, sigma_n(iter))', N_len, g3, 0, send_bits, 0, 0, 0);
