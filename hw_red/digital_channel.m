function output_bits = digital_channel(input_bits, N_bits, R, T, b, rou, sigma_n, Is_plot_scatter, Send_acquire_beta, Recv_acquire_beta)
% R-retransmisson times
